 ...
 *
 */
public class AlgorithmES2 extends AbstractEA {
	...
	public AlgorithmES2(int mu, int lambda, ISelection selectionAlgorithm, IMutation mutation) {
		this.MU = mu;
		this.LAMBDA = lambda;
	...
	public AlgorithmES2(int mu, int lambda, ISelection selectionAlgorithm) {
		this(mu, lambda, selectionAlgorithm, new MutationUncorrelated());
	}
	
	public AlgorithmES2(int MU, int LAMBDA, ISelection selectionAlgorithm, double ALPHA, double EPSILON) {
	    this(MU,LAMBDA, selectionAlgorithm, new MutationUncorrelated(ALPHA, EPSILON));
	}
	
	public AlgorithmES2(int MU, int LAMBDA, ISelection selectionAlgorithm, double ALPHA) {
        this(MU,LAMBDA, selectionAlgorithm, new MutationUncorrelated(ALPHA));
    }
	
	public AlgorithmES2(int MU, ISelection selectionAlgorithm) {
        this(MU, 100, selectionAlgorithm, new MutationUncorrelated());
    }
	
	public AlgorithmES2(ISelection selectionAlgorithm){
