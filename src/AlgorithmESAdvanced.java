...
public class AlgorithmESAdvanced extends AbstractEA {
    ...
    public AlgorithmESAdvanced(int MU, int LAMBDA, IMutation mutation){
        ...
        survivalSelection = new SurvivalSelectionMuCommaLambda(new SelectionAbsoluteFitness(MU));
    }
...
//        recombination.setPopulation(population.getIndividuals()); //RecombinationDiscreteAndIntermediate doesn't use population 
